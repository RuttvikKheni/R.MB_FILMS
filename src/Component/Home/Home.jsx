                ...
                <div style={{ width: "100%" }} id="carouselExampleCaptions" className="col-11 col-sm-11 col-md-10 col-lg-8 col-xl-8 mx-auto carousel p-5 slide" data-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src={Slide1} className="d-block w-100" alt="Slider Images" />
                        ...
                        <div className="carousel-item">
                            <img src={Slide2} className="d-block w-100" alt="Slider Images" />
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        <div className="carousel-item">
                            <img src={Slide3} className="d-block w-100" alt="Slider Images" />
                            <div className="carousel-caption d-none d-md-block">
